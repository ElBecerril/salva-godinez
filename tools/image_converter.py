...
from tools._file_helpers import safe_output_path as _safe_output_path_full
...
def _safe_output_path(output_dir: str, base_name: str, ext: str) -> str:
    """Genera ruta de salida con sufijo numerico si ya existe (wrapper de firma vieja)."""
    return _safe_output_path_full(os.path.join(output_dir, f"{base_name}{ext}"))
